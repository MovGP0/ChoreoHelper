...
public sealed class SetColorBasedOnLevelBehavior : IBehavior<ChoreographyItemViewModel>
{
    ...
    public void Activate(ChoreographyItemViewModel viewModel, CompositeDisposable disposables)
    {
        viewModel
